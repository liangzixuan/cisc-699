...
> **Status:** Draft 1 (Claude-assisted). Student revision required before W1 submission.
...
**Revision notes for the student.** Read this paragraph aloud. If any sentence sounds like Claude wrote it (e.g., "yielding a reusable methodology" is a smell), rewrite it. The graders are looking for a sharply framed problem in your own voice — not for elegant prose. Cut adjectives. Keep specifics.
